...
# Setting up screen for the simulation
screen_width = 800
screen_height = 556
...
class Car(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        for radar_angle in (-90, -45, 0, 45, 90):
    ...
    def collision(self):
        ...
        # Ensure points are within screen boundaries
    ...
    def radar(self, radar_angle):
        ...
        while length < 100:
            ...
            # Check if the x, y are within the screen boundaries
